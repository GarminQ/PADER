...
namespace drec::paillier0
{
	...
	public:
		...
		std::vector<std::vector<std::vector<phez::PackedCiphertext>>> item_update_buffer;

		// Cached variables for faster computation
		std::vector<std::vector<phez::PackedCiphertext>> cached_vs_ct;
		std::vector<std::vector<phez::PackedCiphertext>> cached_social_us_ct;
		std::vector<std::vector<phez::PackedCiphertext>> cached_social_neg_us_ct;
		...
		std::vector<size_t> client_inbound_sizes;
		std::vector<size_t> client_outbound_sizes;
